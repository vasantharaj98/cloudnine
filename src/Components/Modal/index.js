...
export default function CustomizedDialogs({
  ...
  const taxes = ( parseFloat(totalAmount) * 0.13).toFixed(2);
  const total =  (parseFloat(totalAmount) + parseFloat(totalAmount * 0.13)).toFixed(2)
  const disCount = (parseFloat(total) * 0.15).toFixed(2);
  const paidAmount = (parseFloat(total) - disCount).toFixed(2);
  ...
  React.useEffect(() => {
    ...
    setDishdata({ ...dishdata, order: updateDish, total: paidAmount });
  }, [dishes]);
                      ...
                      >
                        ...
                        >
                          <Button
                            sx={{ minWidth: 0 }}
                            onClick={() => {
                              const newState = dishes.map((obj) => {
                                if (obj.dishname === e.dishname) {
                                  return {
                                    ...obj,
                                    qty: Math.max(e.qty - 1, 0),
                                  };
                                }
                                return obj;
                              });
                        ...
                        <Button
                          ...
                          onClick={() => {
                            setDishes((current) =>
                              current.filter((dish) => {
                                return dish.dishname !== e.dishname;
                              })
                            );
                          }}
                        >
          ...
          <DialogActions sx={{ my: 2 }} className="cart">
            <div style={{ display: "flex" }}>
              <div style={{ marginRight: 30 }}>
                ...
                <Typography component="p" variant="p" sx={{color: '#20B038'}}>
                  Discount (15%) :
                </Typography>
                <Typography component="h4" variant="p">
                  Paid Amount :
    ...
    return (
      <div>
        <Button
          ...
          onClick={handleClickOpen}
        >
          <Typography variant="p" component="h3" sx={{ marginRight: 1 }}>
            {" "}
            Cart
          </Typography>
          ...
          <DialogContent dividers>
            ...
            >
              ...
              <TextField
                ...
                onChange={(e) =>
                  setDishdata({ ...dishdata, message: e.target.value })
                }
              />
            </Box>
          </DialogContent>
      ...
      <div>
        ...
        >
          ...
          <DialogContent dividers>
            ...
            >
              {success &&
                "An email has been sent for your reference. You will get a notification to your mobile number regarding status of your order."}
            </Typography>
            <div className="locate_order">
              ...
              <div style={{ display: "flex", justifyContent: "spaceBetween" }}>
                ...
                <Typography
                  variant="p"
                  component="p"
                  sx={{ lineHeight: 1.5, marginLeft: 1 }}
                >
                  +19059036360
                </Typography>
              </div>
            ...
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2877.6977524637605!2d-79.03672116878191!3d43.84136458147075!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d4dfa401678975%3A0xbd54d5f97074a11!2sCLOUD%20NINE%20BAR%20%26GRILL!5e0!3m2!1sen!2sin!4v1673412721486!5m2!1sen!2sin"
                width="300px"
                height="200px"
                style={{ border: 0 }}
                allowfullscreen=""
            ...
            >
              <Link
                href="https://goo.gl/maps/JZtXWi1vxqujv6kKA"
                target="_blank"
