export const tabPanel = [
    ...
    menu: [{
        menuName: "Calamari",
        menuCoice: "Breaded calamari, jalapeño, bell peppers with sweet chili sauce ",
        price: [{
          size: "",
          price: "12.45"
              }]
...
},
{
  ...
  price: [{
    ...
    },
    {
        ...
        menuCoice: "Beef burger patty with lettuce, tomato, onion, pickle, crispy bacon, fried jalapeño, Swiss cheese, salsa sauce served with fries, garden salad",
        price: [{
          size: "",
          price: "16.95"
              }]
  ...
  },
  {
    ...
    menuCoice: "Double meat burger, lettuce, tomato, onion pickle, bacon, jalapeños, Swiss cheese, cheddar served with fries, garden salad",
    price: [{
      size: "",
      price: "18.95"
          }]
    ...
    },
    {
        ...
        menuCoice: "Grilled chicken, sautéed peppers and onion mixed green mixed cheese, tomatoes, avocado with sour cream served with fries, garden salad",
        price: [{
          size: "",
          price: "14.95"
              }]
  ...
  },
  {
    ...
    menuCoice: "Choice of 3 items from Cloud’s platter and choice of 2 items from Cloud’s vegetarian platter",
    price: [{
      size: "",
      price: "29.95"
          }]
},
{
  ...
  menuCoice: "Tortilla Chips covered with mix cheese Jalapeños, tomatoes, green onions, served with salsa and sour cream Extra cheese 3.95",
  price: [{
    size: "",
    price: "14.95"
        }]
