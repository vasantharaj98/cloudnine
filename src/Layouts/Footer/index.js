...
const Footer = () => {
  return (
    <Container sx={{marginTop: 5}}>
            ...
            <Typography variant="p" component="p" sx={{marginTop: 4, width: "60%", lineHeight: 2}}>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.</Typography>
            <Box
                sx={{
                width: "100%",
                height: "100%",
