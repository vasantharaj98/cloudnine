...
export const SubFooter = () => {
  return (
    <Container sx={{marginTop: 5}}>
            <Typography className='un_line' variant="h" component="h2">Find Boon Bite Restaurant at,</Typography>
            <Typography variant="p" className='footer_con' component="p" sx={{marginTop: 4, lineHeight: 2}}>Our Boon Bite Restaurant Could be Near You!</Typography>
            <Box
                sx={{
                width: "100%",
                height: "100%",
    ...
    >
        ...
        <div style={{display: 'flex', justifyContent: 'spaceBetween', gap: 20, marginTop: 15, flexWrap: 'wrap'  }}>
            ...
            <Link href='https://goo.gl/maps/JZtXWi1vxqujv6kKA' target="_blank" sx={{textDecoration:"none", display: 'flex', justifyContent: 'spaceBetween', color: '#fff'}}>
                <FmdGoodOutlined/>
                <Typography variant="p" component="p" sx={{ lineHeight: 1.5, marginLeft: 1}}>Boon Bite, 368 Bayly St W, Ajax, ON L1S 1P1, Canada</Typography>
            </Link>
            </div>
            <div>
            <Link href='tel: +19059036360' sx={{textDecoration:"none", display: 'flex', justifyContent: 'spaceBetween', color: '#fff'}}>
                <LocalPhoneOutlined/>
                <Typography variant="p" component="p" sx={{ lineHeight: 1.5, marginLeft: 1}}>+1905967857567</Typography>
            </Link>
            </div>
        </div>
        ...
        <Grid item md={6}>
        <iframe src="https://www.google.com/maps/embed?!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d4dfa401678975%3A0xbd54d5f97074a11!2sBOON%20BITE%20BAR%20%26GRILL!5e0!3m2!1sen!2sin!4v1673412721486!5m2!1sen!2sin" width="100%" height="100%" style={{border: 0}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </Grid>
      </Grid>
    </Box>
    </Container>
    ...
    <Typography className='un_line1' variant="h" component="h2" sx={{textAlign: 'center'}}>Connect with us @</Typography>
        ...
        <div>
            ...
            <Link href='tel: +19059036360' sx={{textDecoration:"none", display: 'flex', justifyContent: 'spaceBetween', color: '#000'}}>
                <LocalPhoneOutlined/>
                <Typography variant="p" component="p" sx={{ lineHeight: 1.5, marginLeft: 1}}>+19059036786</Typography>
            </Link>
            </div>
        </div>
        <div style={{display: 'flex', justifyContent: 'center', marginTop: 40 }}>
            <div style={{display: 'flex', justifyContent: 'spaceBetween', gap: 20 }}>
                <a href='#' target="_blank"><img src={Facebook} alt="fb"></img></a>
                {/* <a href='#'><img src={Twitter} alt="twitter"></img></a>
                <a href='#'><img src={Whatsapp} alt="wa"></img></a>
                <a href='#'><img src={Facebook_Mess} alt="fb_m"></img></a> */}
                <a href='#' target="_blank"><img src={Instagram} alt="insta"></img></a>
                <a href='#' target="_blank"><img src={TikTok} alt="insta"></img></a>
            </div>
        </div>
    </div>
    </div>
